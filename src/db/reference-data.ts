    ...
    operations: [
      {
        ...
        responseSchemaJson: {
          fields: [
            ...
            { name: "customer_master_id", type: "string" },
            { name: "customer_master_status", type: "string" },
            { name: "customer_order_status", type: "string" },
            { name: "customer_order_created_at", type: "string" },
          ],
        },
      ...
      },
      {
        ...
        responseSchemaJson: {
          fields: [
            ...
            { name: "product_master_id", type: "string" },
            { name: "product_master_type", type: "string" },
            { name: "product_master_status", type: "string" },
          ],
        },
